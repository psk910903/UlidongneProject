...
public class Service1 {
    ...
    public List<MeetingResponseDto> findMeetingByClubIdx(Long idx){ // 클럽 번호로 미팅 찾기
        ...
        try{
            List<Meeting> entityList = meetingRepository.findByMeetingClub(idx);
